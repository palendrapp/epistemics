...
The [current delivery strategy](docs/decision-value-pilot.md) targets one portable behavioral claim that improves a concrete buyer decision: whether to require independent verification before accepting a research conclusion. The [sixteen-session repeatability and research-packet comparison](docs/source-panel-results-2026-09-26.md) is complete. It supports reporting scoped repeatability and presentation results, while configuration-specific fits added no transfer benefit. Clearer research instructions and a measured verification comparison precede wider battery expansion. General support benefit is tested separately from personalization; a bounded design-partner assessment can test demand before automated payment infrastructure is needed.
