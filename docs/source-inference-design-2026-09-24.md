...
Detailed design proposal, 24 September 2026. **Simulator/discrimination milestone implemented on 25 September; source-learning collection, synthetic acceptance and one fresh-agent acceptance completed on 26 September. Actual human acceptance remains pending.** The [laboratory specification](source-inference-lab.md), [laboratory results](source-inference-results-2026-09-25.md), [collection specification](source-learning.md) and [fresh-agent results](source-learning-acceptance-2026-09-26.md) distinguish the implemented subset from the broader design below. The [26 September decision-value plan](decision-value-pilot.md) brings repeatability, a transfer bridge and one useful support/verification decision ahead of broader source-label/drift work. This extends the [earlier review](cognitive-modeling-review-2026-09-20.md) in response to the narrative results. Existing batteries, active human sessions and issued evidence remain unchanged.
