...
The [24 September source-inference proposal](source-inference-design-2026-09-24.md) develops the next design in detail after the narrative results: persistent source learning, competence versus selection, explicit competing models, diagnostic contrasts, less prompted discovery and tested support. Its [offline design laboratory](source-inference-lab.md) has [synthetic discrimination results](source-inference-results-2026-09-25.md), and the follow-on [source-learning collection](source-learning.md) implements consistent browser/MCP participation with frozen later forecasts. Its [synthetic acceptance](source-learning-results-2026-09-26.md) is complete; fresh-agent and actual human acceptance remain next. Earlier tasks and active sessions are unchanged.
