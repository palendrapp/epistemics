...
The [20 September development run and frozen budget](prediction-budget-2026-09-20.md) provide actual token/latency measurements and include failed setup attempts. After the original collection stopped, a documented recovery amendment [completed all 144 profile episodes and locked predictions](prediction-profile-2026-09-20.md). The [full 432-episode comparison is now complete](prediction-results-2026-09-20.md), with `criteria_not_met`: individual profiles did not outperform pooling, the reference-calibration gain missed the minimum, and two configurations exceeded the absolute error ceiling. Assistance benefit remains untested.
