...
The [first actual fresh-agent run](investigation2-acceptance-2026-09-21.md) has now completed all 12 cases and 198 probability reports in 8 minutes 50 seconds. It shows coherent decisions and prospective research expectations, the intended matched-price choice contrast and revisions to all four nonzero corrections. The conditional cognitive fit remains inadequate at 11.86 points RMSE. An exploratory check of the same joint observer scores 12.90 points with starting-report conditioning versus 7.62 without it, implicating the initialization/observation assumption rather than identifying a stable trait. All six review respondents also flagged contradictory transcription-status wording. The frozen implementation and results are preserved.

Next make versioned wording fixes and compare explicit initial-response models before a separately frozen repeat/new-case test. A private actual-human entry point is prepared, but no human acceptance result is available. Record carryover and the burden/effect of prospective elicitation. Further model development needs recovery validation and new empirical prediction checks before predictive passport claims. Targeted support follows a repeatable difficulty; no assistance benefit is currently established.
