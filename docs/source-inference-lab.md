...
The [first results](source-inference-results-2026-09-25.md) guide the next collection design. Source-label priors, error-driven source learning, drift, semantic interpretation, sparse-versus-dense elicitation, human usability and measured support remain future work. The laboratory's inference is an original bounded adaptation of the literature reviewed in the [proposal](source-inference-design-2026-09-24.md), not a replication of those experiments.
