...
Fresh-agent acceptance should next measure completion, usability, cost, candidate adequacy and new-case prediction against the simple baselines. Actual human usability is a separate task. A broader comparison of elicitation conditions, repeatability, source labels, drift and support benefit follows only after that feasibility check.
