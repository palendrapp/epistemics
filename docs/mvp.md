...
| Active discovery development | 0.2 recovery checks and completed 12-case fresh-agent acceptance: coherent decisions/research expectations, matched price response and actual correction handling; shared human/MCP collection | Versioned wording fixes, initial-response model revision, actual human acceptance, repeatability and a frozen predictive comparison; conditional model fit remains inadequate |
