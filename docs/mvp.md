...
| Active discovery development | 0.3 synthetic recovery and completed 36-episode fresh-agent pilot: descriptive repeatability, frozen conditional predictions and three evidence-linked passports; shared human/MCP collection | Actual human acceptance; matched contrasts separating causal assumptions, selective propagation and report expression; parameter explanations still lack adequate new-case fit |
...
Next complete actual human acceptance and design a small set of matched causal/auxiliary contrasts. An exploratory residual audit found much larger changes to company forecasts than source/backlog forecasts; the current source-feedback/shared-response-rate model cannot distinguish all explanations for that pattern. Validate a revised model family against those contrasts before another broad collection. In parallel establish the registered-provider consumer demonstration. Hosted paid evaluation jobs remain the next commercial milestone; targeted interventions require their own benefit comparison.
