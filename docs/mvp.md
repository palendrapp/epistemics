...
| Active discovery development | 0.3 recovery checks and completed 0.2 12-case fresh-agent acceptance: coherent decisions/research expectations, matched price response and actual correction handling; shared human/MCP collection | 0.3 wording fixes, three initial-response models, synthetic recovery and passport integration now implemented; actual human acceptance, repeatability and a frozen new-case comparison remain pending |
...
The [0.3 investigation revision](company-investigation-v3.md) is implemented and the [passport integration](investigation-passport.md) is complete locally: unchanged source reports become readable/JSON profiles, signed attestations and consumer measurements. Both synthetic parameter-recovery runs pass. This is implementation and model-family validation; no new real-agent or human acceptance has been collected for 0.3.
...
Next freeze and run the [bounded acceptance/repeatability pilot](investigation-passport.md#next-evidence-milestone): one configuration, development cases, fresh-context repeats and new cases, alongside actual human usability acceptance. Then establish the registered-provider consumer demonstration. Hosted paid evaluation jobs remain the next commercial milestone; targeted interventions require their own benefit comparison.

## Delivery order

| Stage | Deliverable | Completion criterion |
| --- | --- | --- |
| 1. Measurement and predictive validation — next evidence milestone | Human core acceptance, repeatability and a costed revision informed by the completed null comparison | On new held-out cases, meet declared prediction criteria before claiming individualized predictive value; separately test assistance benefit after cost |
