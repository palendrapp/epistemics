...
Next audit the large residuals, repeatability and response comprehension before expanding model complexity. Terra's five largest misses account for 98.8% of its squared error, an exploratory clue that average weights alone may miss occasional large deviations. Use the completed cases for development, freeze any revised model and evaluate genuinely new held-out cases under a measured budget. Do not refit these outcomes and present them as new validation.
