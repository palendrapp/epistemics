...
from epistemics.diagnostic.battery import INSTRUCTIONS, public_trial, schedule
from epistemics.diagnostic.models import Answer, Manifest, Observation, Report
...
def export(directory):
    from epistemics.diagnostic.inference import analyze
    ...
    report = Report(
        ...
        limitations=[
            "Authored diagnostic contrasts with empirical archives, not unrestricted causal discovery.",
            ...
            "Shared coefficients, a fixed 0.5 baseline and fixed report noise can be misspecified; fitted parameters are not passport traits.",
            "Direct audit/report smoothing may differ from uncertain evidence use. No empirical validation or intervention benefit.",
