...
from epistemics.diagnostic2.service import DiagnosticService, load, save
...
class LocalServer(ThreadingHTTPServer):
    ...
    def current(self):
        for i, a in enumerate(self.manifest.assignments):
            service = DiagnosticService(self.directory, a.assignment_id)
    ...
    def do_POST(self):
        ...
        try:
            ...
            with self.server.lock:
                ...
                service = DiagnosticService(self.server.directory, target)
                result = (
