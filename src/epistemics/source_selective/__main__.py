...
def main():
    ...
    if a.command == "create":
        ...
        from epistemics.source_selective.web import serve

        serve(a.directory, a.port)
    elif a.command == "export":
        VerificationService(a.directory).evidence()
    else:
        from epistemics.source_selective.simulation import recovery
        ...
        plan = {
            ...
            "gates": "original source-learning recovery gates, separately for all three assigned policies",
        }
