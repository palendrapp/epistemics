...
from epistemics.investigation2 import BATTERY_VERSION
from epistemics.investigation2.battery import INSTRUCTIONS, public_trial
from epistemics.investigation2.inference import analysis, answer_vector, report_log_likelihood
from epistemics.investigation2.models import (
...
def fingerprint():
    from epistemics.investigation.service import fingerprint as original_fingerprint
...
def export(directory):
    from epistemics.investigation2.render import collection_analysis, render
        ...
        with service.state() as state:
            ...
            report = InvestigationReport(
                ...
                limitations=[
                    ...
                    "Conditional fits use starting reports and chosen branches; they do not establish stable traits, real-participant parameter recovery, transfer or intervention benefit.",
