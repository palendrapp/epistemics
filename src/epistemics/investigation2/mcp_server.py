...
from epistemics.investigation2.models import Answer as InvestigationAnswer
...
def main():
    create_server(os.environ["EPISTEMICS_INVESTIGATION2"], os.environ["EPISTEMICS_ASSIGNMENT"]).run(
        transport="stdio"
    )
