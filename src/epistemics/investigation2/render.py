...
from epistemics.investigation2.inference import fit
...
def collection_analysis(reports, hashes):
    ...
    return {
        "schema_version": "epistemics.investigation-summary.v2",
...
def render(reports, aggregate):
    ...
    lines = [
        "# Investigation 0.2: development evidence",
        "",
        ...
        "",
        f"Conditional model fit: **{fit['status']}**, RMSE **{fit['report_rmse_pp']:.2f} probability points**. Source-feedback coupling {fit['coupling_grid_estimate']:.2f}; report response rate {fit['response_rate_grid_estimate']:.2f}. These are parameters of this observer family, conditioned on starting reports; no passport label is issued.",
        "",
