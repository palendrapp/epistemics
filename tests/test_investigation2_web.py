...
from test_investigation2 import PARTICIPANT
from test_live_web import BrowserClient

from epistemics.investigation2.models import Trial
from epistemics.investigation2.service import InvestigationService, create
from epistemics.investigation2.simulation import response
from epistemics.investigation2.web import LocalServer
...
const source=fs.readFileSync("src/epistemics/investigation2/assets/app.js","utf8").replace(/init\(\);\s*$/,"");
...
def test_whole_human_battery_next_case_retries_never_skip(tmp_path):
    with running(tmp_path, collection=True) as (base, server):
        ...
        from epistemics.investigation2.service import status
