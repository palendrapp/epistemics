...
from epistemics.investigation2.cli import server_parameters
from epistemics.investigation2.models import Trial
from epistemics.investigation2.service import create
from epistemics.investigation2.simulation import response


def test_v2_real_mcp_transport_and_prospective_expectations(tmp_path):
